...
server <- function(input, output) {
  ...
  avg_thresholds_data <- drawThresholdsDataAvg(data_avg, input$dataset, thresholds)
  min_thresholds_data <- drawThresholdsDataMin(data_maxmin, input$dataset, thresholds)
  max_thresholds_data <- drawThresholdsDataMax(data_maxmin, input$dataset, thresholds)

  # gets markers for average/max/min lines, for the other line
  second_avg_thresholds_data <- drawThresholdsDataAvg(second_data_avg, input$dataset, thresholds)
  second_min_thresholds_data <- drawThresholdsDataMin(second_data_maxmin, input$dataset, thresholds)
  second_max_thresholds_data <- drawThresholdsDataMax(second_data_maxmin, input$dataset, thresholds)
    ...
    plot <- ggplot() +
      ...
      geom_ribbon(data = second_data_maxmin, aes(x = timestamp, ymin = daily_min, ymax = daily_max), fill = "#00ff7595") +
    ...
    geom_point(data = subset(avg_thresholds_data, low_flag), aes(x = timestamp, y = daily_avg), color = "blue", size = 2, shape = 6) +
    ...
    geom_point(data = subset(min_thresholds_data, low_flag), aes(x = timestamp, y = daily_min), color = "blue", size = 2, shape = 6) +
    ...
    geom_point(data = subset(max_thresholds_data, low_flag), aes(x = timestamp, y = daily_max), color = "blue", size = 2, shape = 6) +
    ...
    geom_point(data = subset(second_avg_thresholds_data, low_flag), aes(x = timestamp, y = daily_avg), color = "blue", size = 2, shape = 6) +
    ...
    geom_point(data = subset(second_min_thresholds_data, low_flag), aes(x = timestamp, y = daily_min), color = "blue", size = 2, shape = 6) +
    ...
    geom_point(data = subset(second_max_thresholds_data, low_flag), aes(x = timestamp, y = daily_max), color = "blue", size = 2, shape = 6) +
